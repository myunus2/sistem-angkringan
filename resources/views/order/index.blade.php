...
<body class="bg-[#FDFDFD] pb-32">
    ...
    <div class="px-4 my-6">
        <div class="snap-x-container flex gap-3 pb-2 no-scrollbar overflow-x-auto justify-start md:justify-center">
    ...
    <div id="cart-fab" class="hidden fixed bottom-6 left-1/2 -translate-x-1/2 z-40">
    ...
    <script>
        ...
        function updateFab() {
            ...
            document.getElementById('cart-fab').classList.toggle('hidden', total === 0);
        }
