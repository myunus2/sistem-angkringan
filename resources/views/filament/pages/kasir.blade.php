<x-filament-panels::page>
    <style>
        /* Desain Kustom - Putih & Oranye (override untuk Dark Mode) */


        /* ===== Dark Mode overrides ===== */
        body.fi-dark .cart-container,
        html.fi-dark .cart-container,
        .fi-dark .cart-container {
            background: #0b1220 !important;
            border-color: #1f2937 !important;
            box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.35) !important;
        }

        body.fi-dark .category-btn,
        html.fi-dark .category-btn,
        .fi-dark .category-btn {
            background: #0b1220 !important;
            border-color: #1f2937 !important;
            color: #e5e7eb !important;
        }

        body.fi-dark .category-active,
        html.fi-dark .category-active,
        .fi-dark .category-active {
            color: white !important;
        }

        body.fi-dark .product-card,
        html.fi-dark .product-card,
        .fi-dark .product-card {
            background: #0b1220 !important;
            border-color: #1f2937 !important;
        }

        body.fi-dark .product-card:hover,
        html.fi-dark .product-card:hover,
        .fi-dark .product-card:hover {
            border-color: #f97316 !important;
            box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.35) !important;
        }

        body.fi-dark .product-qty-badge,
        html.fi-dark .product-qty-badge,
        .fi-dark .product-qty-badge {
            border-color: #0b1220 !important;
        }

        body.fi-dark .price-tag,
        html.fi-dark .price-tag,
        .fi-dark .price-tag {
            color: #f97316 !important;
        }

        body.fi-dark .btn-pay,
        html.fi-dark .btn-pay,
        .fi-dark .btn-pay {
            color: #fff !important;
        }

        body.fi-dark .checkout-banner,
        html.fi-dark .checkout-banner,
        .fi-dark .checkout-banner {
            background: rgba(11, 18, 32, 0.92) !important;
            border-color: #1f2937 !important;
        }

        body.fi-dark .checkout-banner .title,
        html.fi-dark .checkout-banner .title,
        .fi-dark .checkout-banner .title {
            color: #e5e7eb !important;
        }

        body.fi-dark .checkout-banner .summary,
        html.fi-dark .checkout-banner .summary,
        .fi-dark .checkout-banner .summary {
            color: #9ca3af !important;
        }

        body.fi-dark .border-gray-50,
        html.fi-dark .border-gray-50,
        .fi-dark .border-gray-50 {
        ...
        body.fi-dark .text-gray-800,
        html.fi-dark .text-gray-800,
        .fi-dark .text-gray-800 {
            color: #f3f4f6 !important;
        }

        body.fi-dark .text-gray-700,
        html.fi-dark .text-gray-700,
        .fi-dark .text-gray-700 {
...
body.fi-dark .text-gray-400,
        ...
        /* ===== Dark mode for hardcoded light theme ===== */
        body.fi-dark .category-btn,
        html.fi-dark .category-btn,
        .fi-dark .category-btn {
            background: #0b1220 !important;
