                    ...
                    <style>
                        ...
                        .dark .favorite-menu-empty {
                            ...
                            /* ==========================================
   MENGUBAH LEBAR (WIDTH) SIDEBAR NAVIGASI
   ========================================== */

@media (min-width: 1024px) {
    /* 1. Perkecil lebar sidebar utama */
    .fi-sidebar,
aside.fi-sidebar {
    ...
    /* tampilkan navigasi (icon) tetap terlihat saat sidebar mengecil */
    ...
    /* pastikan label tidak hilang total (tetap ada untuk tooltip bila ada) */
    .fi-sidebar-item-button .fi-sidebar-item-label {
        display: none !important;
    }


    /* 2. Menyesuaikan layout konten utama agar tergeser mengikuti lebar sidebar baru */

    html:not(.fi-sidebar-close) .fi-main {
        padding-inline-start: 3.25rem !important; /* Harus sama dengan width sidebar */
    }

}
                    </style>
                <?php /**PATH C:\xampp1\htdocs\sistem-angkringan\storage\framework\views/4ea2e8fe64114efcb292e7cc300ba8fe.blade.php ENDPATH**/ ?>